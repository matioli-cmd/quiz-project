...
function CreateQuestion({checked, handleCheckedAnswer, questionTitle, handleQuestionTitle, Answer1, Answer2, Answer3, Answer4, handleAnswerChange}){
    ...
    return(
        <div className={styles.QuestionContainer}>
            <input className={styles.QuestionTitle} placeholder='Question title'  maxLength={25} value={questionTitle} onChange={(e) => handleQuestionTitle(e)}></input>
            <div className={styles.Answers}>
    <div className={styles.Answer1}>
         <input className={styles.AnswerInput} value={Answer1} maxLength={25} onChange={(e) => handleAnswerChange(e,'Answer1')} placeholder='Input answer'></input>
    ...
    <div className={styles.Answer2}>
        <input className={styles.AnswerInput} value={Answer2} maxLength={25} onChange={(e) => handleAnswerChange(e,'Answer2')} placeholder='Input answer'></input>
    ...
    <div className={styles.Answer3}>
        <input className={styles.AnswerInput} value={Answer3} maxLength={25} onChange={(e) => handleAnswerChange(e,'Answer3')} placeholder='Input answer'></input>
    ...
    <input className={styles.AnswerInput} value={Answer4} maxLength={25} onChange={(e) => handleAnswerChange(e,'Answer4')} placeholder='Input answer'></input>
